...
// Minimum and Maximum values for tracking feerates, in enamo per kB
static constexpr double MIN_FEERATE = COIN / 1000.0;  //!< 100,000 - equals 100 enamo per byte
static const double MAX_FEERATE = COIN * 10.0;    //!< 1000,000,000 enamo - equals 10 DOGE/kb

// Feerate and priority for the upper border of the highest bucket, in enamo per kB
