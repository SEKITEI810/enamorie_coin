...
#define QAPP_ORG_NAME "Enamorie Coin"
#define QAPP_ORG_DOMAIN "enamorie.org"
#define QAPP_APP_NAME_DEFAULT "Enamorie Coin-Qt"
#define QAPP_APP_NAME_TESTNET "Enamorie Coin-Qt-testnet"
