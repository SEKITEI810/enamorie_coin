...
// Copyright (c) 2022 The Enamorie Coin Core developers
...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Enamorie Coin Core repository on GitHub"),
        tr("Services that claim to double your enamories are always ponzi schemes")
    };
