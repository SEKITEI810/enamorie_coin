...
{
    const char* pszTimestamp = "Enamorie Coin - Love is the currency of tomorrow - 2025/04/26";
...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 525600; // ~6 months at 30s block time
        ...
        consensus.nPowTargetSpacing = 30; // 30 seconds — fast confirmations for UX
        consensus.fDigishieldDifficultyCalculation = false;
        consensus.nCoinbaseMaturity = 10; // faster maturity for better miner UX
        ...
        // AuxPoW parameters
        consensus.nAuxpowChainId = 0x00E5; // 229 - Enamorie!
        ...
        pchMessageStart[2] = 0xe3; // A
        pchMessageStart[3] = 0xe2; // M
        nDefaultPort = 33776;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1745625600, 0, 0x1e0ffff0, 1, 2025 * COIN); // Enamorie genesis: 2025-04-26

        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        // TODO: Update genesis hash after mining genesis block
        // assert(consensus.hashGenesisBlock == uint256S("0x..."));
        // assert(genesis.hashMerkleRoot == uint256S("0x..."));

        // Note that of those with the service bits flag, most only support a subset of possible options
        // Enamorie Coin DNS seeds — replace with actual seed nodes before launch
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,33); // "E" prefix
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,28); // "e" prefix
...
public:
    CTestNetParams() {
        ...
        pchMessageStart[0] = 0xd5; // testnet E
        pchMessageStart[1] = 0xd4; // testnet N
        pchMessageStart[2] = 0xd3; // testnet A
        pchMessageStart[3] = 0xd2; // testnet M
        nDefaultPort = 44776;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1745625600, 1, 0x1e0ffff0, 1, 2025 * COIN); // Enamorie testnet genesis
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        minDifficultyConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        // genesis hash assertion — update after mining genesis block
        // merkle root assertion — update after mining genesis block
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1745625600, 2, 0x207fffff, 1, 2025 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        // genesis hash assertion — update after mining genesis block
